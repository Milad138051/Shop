                        ...
                        <div class="mb-4">
                            ...
                            @else
                                <a href="" class="btn btn sm btn-danger block w-full rounded-lg px-3 py-2 mt-4"
                                    data-bs-toggle="modal" data-bs-target="#add-address">ایجاد
                                    ادرس جدید</a>
                                                ...
                                                <form class="row" method="post"
                                                    ...
                                                    <section class="col-12 mb-2">
                                                        ...
                                                        <input value="{{ old('recipient_name') }}" type="text"
                                                            name="recipient_name" class="form-control form-control-sm"
                                                            id="recipient_name" placeholder="نام تحویل گیرنده">
                                                    ...
                                                    <section class="col-6 mb-2">
                                                        <label for="postal_code" class="form-label mb-1">کد
                                                            پستی</label>
                                                        <input value="{{ old('postal_code') }}" type="text"
