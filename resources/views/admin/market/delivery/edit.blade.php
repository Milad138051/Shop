                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.market.delivery.update',$delivery) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="delivery_time" value="{{ old('delivery_time',$delivery->delivery_time) }}"
                                class="form-control form-control-sm">
                            @error('delivery_time')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="delivery_time_unit" value="{{ old('delivery_time_unit',$delivery->delivery_time_unit) }}"
                                class="form-control form-control-sm">
