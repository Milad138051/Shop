                        ...
                        <tbody>
                            ...
                            <tr class="table-primary">
                               ...
                               <tr class="border-bottom">
                                ...
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_final_amount ?? '0' }} تومان
                                </td>
                            </tr>
                               <tr class="border-bottom">
                                <th>مجموع تمامی مبلغ تخفیفات</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_discount_amount ?? '0' }} تومان
                                </td>
                            </tr>
                               <tr class="border-bottom">
                                <th>مبلغ تخفیف همه محصولات</th>
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_total_products_discount_amount ?? '0' }} تومان
                                </td>
                            </tr>
                               <tr class="border-bottom">
                                <th>مبلغ نهایی</th>
                              ...
                              <tr class="border-bottom">
                                ...
                                <td class="text-left font-weight-bolder">
                                    {{ $order->order_common_discount_amount ?? '0' }} تومان
                                </td>
                            </tr>
                              <tr class="border-bottom">
                                <th>وضعیت سفارش</th>
