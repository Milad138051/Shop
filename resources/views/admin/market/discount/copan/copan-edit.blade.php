                    ...
                    <form action="{{ route('admin.market.discount.copan.update',$copan) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="code"
                                value="{{ old('code',$copan->code) }}"class="form-control form-control-sm">
                            @error('code')
                        ...
                        <div class="form-group">
                            ...
                            <select name="user_id" id="users" class="form-control form-control-sm" disabled>
                                @foreach ($users as $user)
                                    <option @if (old('user_id',$copan->user_id) == $user->id) selected @endif value="{{ $user->id }}">
                                        {{ $user->name }}</option>
                                @endforeach
                            </select>
                            @error('user_id')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="discount_ceiling" value="{{ old('discount_ceiling',$copan->discount_ceiling) }}"
                                class="form-control form-control-sm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('start_date',$copan->start_date) }}" name="start_date" id="start_date"
                                class="form-control form-control-sm d-none">
                            <input type="text" value="{{ old('start_date',$copan->start_date) }}" id="start_date_view"
                                class="form-control form-control-sm">
                            @error('start_date')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('end_date',$copan->end_date) }}" name="end_date" id="end_date"
                                class="form-control form-control-sm d-none">
                            <input type="text" value="{{ old('end_date',$copan->end_date) }}" id="end_date_view"
                                class="form-control form-control-sm">
                            @error('end_date')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
