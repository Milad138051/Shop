                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.market.discount.commonDiscount.store') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="start_date" value="{{old('start_date')}}" id="start_date" class="form-control form-control-sm d-none">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="end_date" value="{{old('end_date')}}" id="end_date" class="form-control form-control-sm d-none">
