      ...
      <div class="card">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <img src="{{ $productCategory->image ? asset($productCategory->image['indexArray'][$productCategory->image['currentImage']] ) : ' ' }}" alt="" width="100" height="50">
                </td>
                <td>
                ...
                <td>
                    <form action="{{route('admin.market.category.delete',$productCategory)}}" method="post">
                        @method('DELETE')
                        @csrf
                        <button type="submit" class="btn btn-danger text-white delete">حذف</button>
                    </form>
                    <a href="{{route('admin.market.category.edit',$productCategory)}}" class="btn btn-primary text-white">ویرایش</a>
                </td>
            </tr>                
            @endforeach
        </tbody>
