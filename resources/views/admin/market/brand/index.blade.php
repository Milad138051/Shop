      ...
      <div class="card">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                  <img src="{{ $brand->logo ? asset($brand->logo['indexArray'][$brand->logo['currentImage']] ) : ' ' }}" alt="" width="100" height="50">
                </td>
                <td>
                    @if($brand->status==1)
                ...
                <td>
                    ...
                    <a href="{{route('admin.market.brand.edit',$brand)}}" class="btn btn-primary text-white">ویرایش</a>
                </td>
            </tr>                
            @endforeach
        </tbody>
