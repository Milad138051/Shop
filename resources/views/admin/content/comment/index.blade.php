        ...
        <div class="card-body table-responsive p-0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $comment->parent_id ? Str::limit($comment->parent->body, 10) : 'والدی ندارد' }}</td>
              ...
              <td>
                ...
                <td>
                  ...
                  <a href="{{route('admin.content.comment.show',$comment)}}" class="btn btn-primary text-white">نمایش</a>
                  <a href="{{route('admin.content.comment.approved',$comment)}}" class="btn btn-warning text-white">تغییر وضعیت</a>
              </td>
            </tr>
            @endforeach
          </tbody>
